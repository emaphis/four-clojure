...
;; item in the second form, making a list of that form if necessary. This
;; process continues for all the forms. Using ->> can sometimes make your code
;; more readable.
